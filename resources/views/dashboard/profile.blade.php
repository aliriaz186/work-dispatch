                        ...
                        <div class="kt-portlet__body">
                            <div class="row">
                                <div class="col-lg-4">
                                    ...
                                    <img onclick="OpenCompanyLogoSelection()" src="{{asset('img/default.svg')}}" style="width: 100px; height: 100px; cursor: pointer">
                                    @else
                                      <img onclick="OpenCompanyLogoSelection()" src="{{asset('logo')}}/{{$technician->logo}}" style="width: 100px; height: 100px; cursor: pointer">
                                    @endif
                                </div>
                            </div>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="email" id="email"
                                               class="form-control"
                                               placeholder="Enter email" value="{{$technician->email}}" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <label>Password
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="password" id="password"
                                               class="form-control"
                                               placeholder="Enter password" value="{{$technician->password}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-4">
