        ...
        <form action="#" method="POST" id="listing_form" class="form-horizontal listing_form">
            ...
            <div class="row">
                <div class="col-xl-4 order-lg-4 order-xl-4">
                    ...
                    @foreach($jobs as $job)
                        <div class="kt-portlet kt-portlet--mobile" style="cursor: pointer;{{$job->status == 'offered' ? 'border-left: 5px solid greenyellow' : ''}} {{$job->status == 'completed' ? 'border-left: 5px solid #5d78ff' : ''}} {{$job->status == 'scheduled' ? 'border-left: 5px solid greenyellow' : ''}} {{$job->status == 'started' ? 'border-left: 5px solid greenyellow' : ''}}">
